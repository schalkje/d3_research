// Source: https://gist.github.com/lvngd/5f120a517a3b7bf607b56eeac093c650
...
export function rectCollide() {
    ...
    var nodeMass;
    var nodeCenterY;
    var size = d => [d.width, d.height]; // Default size accessor
    ...
    force.initialize = function (_) {
        sizes = (nodes = _).map(function (d) { return size(d); });
