...
class LayerNetworkGraphClass extends Component {
  constructor(props) {
    super(props);
  ...
  // function LayerNetworkGraph({ layers, nodes, links }) {
  // const ref = useD3(
  //   (svg) => {
  ...
  //       // .force("collide", d3.forceCollide(alpha))
...
export default LayerNetworkGraphClass;
